              ...
              <>
                ...
                >
                  <div className="flex-1">
                    ...
                    <p className="text-xl font-medium mb-8">{mainProject.description}</p>
                    
                    <div className="space-y-6">
                      <div>
                        <h4 className="text-lg font-semibold mb-2">项目概述</h4>
                        <p className="text-base leading-relaxed">{mainProject.description}</p>
                      </div>
                      
                      <div>
                        <h4 className="text-lg font-semibold mb-2">主要功能</h4>
                      ...
                      <div>
                        <h4 className="text-lg font-semibold mb-2">技术栈</h4>
                ...
                <div className="flex flex-col gap-6">
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <h3 className="text-2xl font-bold mb-3">发现更多项目</h3>
                      <p className="text-base mb-6">每一个项目都是一个独特的故事</p>
                      <div className="flex flex-wrap gap-2">
                    ...
                    <div className="mt-auto pt-6 flex items-center justify-end">
                      ...
                      >
                        换个项目看看 <RefreshCcw className="ml-2 h-4 w-4" />
                      </motion.div>
                    </div>
                  </motion.div>
                    ...
                    {secondaryProject && (
                      ...
                      >
                        ...
                        <div className="flex-1">
                          ...
                          <p className="font-medium mb-4">{secondaryProject.description}</p>
                        ...
                        <div className="mt-auto pt-6 flex items-center justify-between">
                          ...
                          <motion.div 
                            ...
                            className="flex items-center text-sm font-medium opacity-0 group-hover:opacity-100 transition-opacity"
                          >
                            点击切换 <ArrowRight className="ml-2 h-4 w-4 rotate-45" />
                          </motion.div>
                        </div>
                      </motion.div>
                    )}
