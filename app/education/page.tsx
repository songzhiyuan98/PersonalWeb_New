              ...
              {selectedCourse && (
                ...
                >
                  <motion.div
                    ...
                    className="bg-white/90 dark:bg-black/80 rounded-lg p-8 max-w-2xl w-full backdrop-blur-xl relative group"
                  ...
                  >
                    ...
                    <motion.button
                      ...
                      onClick={() => setSelectedCourse(null)}
                      className="absolute top-4 right-4 p-2 rounded-full bg-black/10 dark:bg-white/10 hover:bg-black/20 dark:hover:bg-white/20 transition-colors"
                    >
                      <X className="h-5 w-5" />
                    </motion.button>
